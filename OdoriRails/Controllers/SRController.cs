...
namespace OdoriRails.Controllers
{
    ...
    {
        private readonly SchoonmaakReparatieRepository _repo = new SchoonmaakReparatieRepository();
        ...
        public ActionResult AddCleaning()
        {
            ...
            if (result is ActionResult) return result as ActionResult;
            var user = (User) result;
            var _logic = new SRLogic(Role.Cleaner);
            var model = new AddCleaningModel();
